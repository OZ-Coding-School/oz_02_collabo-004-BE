...
from .views import CreateChallenge, ChallengeList, UpdateChallenge, UserChallengeList, UserChallengeDetail, UserChallengeDo, CreateDIComment, ChallengeSpoilerComment, UpdateDIComment, DeleteDIComment, UserChallengeStatus
