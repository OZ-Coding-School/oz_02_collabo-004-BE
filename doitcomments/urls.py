...
# 챌린지 스포일러 댓글 생성, 가져오기, 수정, 삭제
    path("dicomment/create/<int:user_id>/<int:challengeinfo_id>/<int:challenge_spoiler_id>",CreateDIComment.as_view(), name="create_dicomment"),
    path("dicomments/<int:challenge_spoiler_id>", ChallengeSpoilerComment.as_view(), name="dicomments_list"),
